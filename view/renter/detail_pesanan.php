    ...
    <div class="tabel">
        <table cellspacing="0">
            ...
            foreach ($transaksi as $row) :
                if (!isset($_GET['keyword']) || $row['tanggal'] == $_GET['keyword'] || $row['username'] == $_GET['keyword'] || $row['nama_gedung'] == $_GET['keyword'] || $row['nama_lapangan'] == $_GET['keyword'] || $row['status'] == $_GET['keyword'] || $row['jam_sewa'] == $_GET['keyword']) :
            ?>
